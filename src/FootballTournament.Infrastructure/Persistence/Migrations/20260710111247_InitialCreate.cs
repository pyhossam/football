        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TournamentCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    MaximumTeams = table.Column<int>(type: "integer", nullable: false),
                    MinimumPlayersPerTeam = table.Column<int>(type: "integer", nullable: false),
                    MaximumPlayersPerTeam = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ExtraTimeDurationMinutes = table.Column<int>(type: "integer", nullable: false),
                    ...
                    EnableExtraTime = table.Column<bool>(type: "boolean", nullable: false),
                    EnablePenaltyShootout = table.Column<bool>(type: "boolean", nullable: false),
                    EnableHomeAndAway = table.Column<bool>(type: "boolean", nullable: false),
                    EnablePlayerApproval = table.Column<bool>(type: "boolean", nullable: false),
                    EnableTeamApproval = table.Column<bool>(type: "boolean", nullable: false),
                    EnableLiveScore = table.Column<bool>(type: "boolean", nullable: false),
                    EnablePublicVisibility = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TournamentSupervisors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TournamentSupervisors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TournamentSupervisors_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentSupervisors_TournamentId_UserId",
                table: "TournamentSupervisors",
                columns: new[] { "TournamentId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TournamentSupervisors_UserId",
                table: "TournamentSupervisors",
                column: "UserId");
        }
